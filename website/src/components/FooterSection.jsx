...
function Footer() {
  ...
  return (
    <FooterContainer>
      <InnerContainer>
        <NameContainer>
          <Header>TRISTAN TSANG</Header>
          <Description>
            A dedicated full stack engineer with passion for innovation and
            product development
          </Description>
        </NameContainer>
        <LinksContainer>
          ...
          <a style={buttonStyle} href="https://github.com/TristanTsang">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <div style={center}>
        <Description>
          @Copyright 2024. Made by <b>Tristan Tsang</b>
        </Description>
      </div>
    </FooterContainer>
  );
